...
if(isset($_POST['profil_duzenle_kaydet']))
{
    ...
    {
        echo '<script type="text/javascript">alert("Güncelleme İşlemi Gerçekleştirilemedi. Tekrar Deneyiniz.");</script> <meta http-equiv="refresh" content="0;URL=ogrenci_bilgileriii.php" />';
